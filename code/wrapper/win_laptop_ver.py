...
TCP_IDLE_TIMEOUT_SEC = 8.0
TCP_HEARTBEAT_REPLY = True
PRINT_TCP_RAW = True
PRINT_TCP_ACK = True
...
# --- Camera
CAM_SOURCE = 0                  # <-- webcam index
CAM_BACKEND = cv2.CAP_DSHOW     # more stable on Windows
CAM_W = 640
CAM_H = 480
CAM_FPS = 30
USE_MJPG = True
